...
const Queen_w_0 = new Queen('Queen_w_0', '7x3', 'w', '♛');
const King_w = new King('King_w', '7x4', 'w', '♚');
...
const Pawn_w_0 = new Pawn('Pawn_w_0', '6x0', 'w', '♟︎');
const Pawn_w_1 = new Pawn('Pawn_w_1', '6x1', 'w', '♟︎');
const Pawn_w_2 = new Pawn('Pawn_w_2', '6x2', 'w', '♟︎');
const Pawn_w_3 = new Pawn('Pawn_w_3', '6x3', 'w', '♟︎');
const Pawn_w_4 = new Pawn('Pawn_w_4', '6x4', 'w', '♟︎');
const Pawn_w_5 = new Pawn('Pawn_w_5', '6x5', 'w', '♟︎');
const Pawn_w_6 = new Pawn('Pawn_w_6', '6x6', 'w', '♟︎');
const Pawn_w_7 = new Pawn('Pawn_w_7', '6x7', 'w', '♟︎');
...
const Queen_b_0 = new Queen('Queen_b_0', '0x3', 'b', '♕');
const King_b = new King('King_b', '0x4', 'b', '♔');
