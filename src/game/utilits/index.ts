...
const Pawn_b_3 = new Pawn('Pawn_b_3', '1x3', 'b', '♟︎');
const Pawn_b_4 = new Pawn('Pawn_b_4', '1x4', 'b', '♟︎');
const Pawn_b_5 = new Pawn('Pawn_b_5', '1x5', 'b', '♟︎');
const Pawn_b_6 = new Pawn('Pawn_b_6', '1x6', 'b', '♟︎');
const Pawn_b_7 = new Pawn('Pawn_b_7', '1x7', 'b', '♟︎');
